...
public class ProjectController implements ProjectDAO {
    ...
    @Override
    public void assignProject(@RequestBody Integer emp_id, @PathVariable Integer project_id) {
                this.jdbcTemplate.update(
                        "insert into currentprojects (project_id,emp_id) values (?,?)", emp_id, project_id);
    }
